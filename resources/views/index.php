...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('translations-manager/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('translations-manager/bootstrap-editable.css') }}" rel="stylesheet"/>
    <script src="{{ asset('translations-manager/jquery-1.11.0.min.js') }}"></script>
    <script src="{{ asset('translations-manager/bootstrap.min.js') }}"></script>
    <script src="{{ asset('translations-manager/bootstrap-editable.min.js') }}"></script>
    <script src="{{ asset('translations-manager/jquery.cookie.js') }}"></script>
